...
try {
    ...
    // Solo mostrar productos si la configuración está activada
    ...
    // Solo mostrar celulares si la configuración está activada
...
<body class="bg-gray-50">
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <!-- PRODUCTOS -->
        <?php if (!empty($productos) && getConfig('catalogo_mostrar_productos', '1') == '1'): ?>
        <section class="mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="p-6">
                        ...
                        <!-- Stock y tiendas -->
                        <?php if (getConfig('catalogo_mostrar_stock', '1') == '1'): ?>
                        ...
                        <!-- Precio -->
                        <?php if (getConfig('catalogo_mostrar_precios', '1') == '1'): ?>
                        ...
                        <div class="flex items-center justify-center">
                            <span class="text-sm text-gray-500 italic">Consultar precio</span>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <!-- CELULARES -->
        <?php if (!empty($celulares) && getConfig('catalogo_mostrar_celulares', '1') == '1'): ?>
        <section class="mb-12">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-3xl font-bold text-gray-900">
        ...
        <!-- Sin resultados -->
        <?php 
        $mostrar_celulares = getConfig('catalogo_mostrar_celulares', '1') == '1';
        $mostrar_productos = getConfig('catalogo_mostrar_productos', '1') == '1';
        
        if (empty($productos) && empty($celulares) && ($mostrar_celulares || $mostrar_productos)): 
        ?>
        ...
        <?php elseif (!$mostrar_celulares && !$mostrar_productos): ?>
        <div class="text-center py-16">
            <svg class="w-24 h-24 mx-auto text-gray-400 mb-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
            </svg>
            <h3 class="text-2xl font-bold text-gray-700 mb-2">Catálogo temporalmente sin contenido</h3>
            <p class="text-gray-500 mb-6">El administrador ha desactivado la visualización de productos</p>
        </div>
        <?php endif; ?>
    ...
    <script>
        ...
        console.log('- Mostrar Precios: <?php echo getConfig("catalogo_mostrar_precios", "1"); ?>');
        console.log('- Mostrar Stock: <?php echo getConfig("catalogo_mostrar_stock", "1"); ?>');
    </script>
